...
for k_concentration in K_list:
    ...
    dt = 1e-10
    time_solver = Time_solver(simulator, dt, t_stop=2e-7, max_iter=4)
    ...
    fname = "/media/andreavs/datadrive/knp_sims_SI/advanced_step_function/knp_left_con_"+ str(k_concentration) +".h5"
    print fname
